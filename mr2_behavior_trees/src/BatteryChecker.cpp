...
#include "mr2_behavior_trees/BatteryChecker.hpp"
...
BatteryChecker::halt()
{
  std::cout << "BatteryChecker halt" << std::endl;
}
...
{
  factory.registerNodeType<mr2_behavior_trees::BatteryChecker>("BatteryChecker");
}
