...
def generate_launch_description():
    launch_rmw_dir = get_package_share_directory('mr2_navigation')
    kobuki_dir = get_package_share_directory('mr2_kobuki')
    ...
    #     PythonLaunchDescriptionSource(os.path.join(kobuki_dir, 'launch', 'kobuki_rplidar.launch.py')))
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=os.path.join(launch_rmw_dir, 'maps', 'casa.yaml'),
